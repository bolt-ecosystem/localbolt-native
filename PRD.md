...
- LAN-only signaling and discovery. Historical Tauri-era cloud signaling was
  superseded by bolt-rendezvous.fly.dev, but LocalBolt does not expose
  cross-network discovery or internet transfer.
